                                            ...
                                            <div class="card card-hover-shadow text-center h-100">
                                                ...
                                                <div class="card-body">
                                                            ...
                                                            <div class="dropdown">
                                                                ...
                                                                <div class="dropdown-menu dropdown-menu-end"
                                                                    ...
                                                                    <a class="dropdown-item text-danger"
                                                                        href="/partner/{{ $partner->id }}/delete">Delete</a>
                                                                </div>
                                                            </div>
                                                            <!-- End Dropdown -->
                                                        </div>
                                                    ...
                                                    <div class="d-flex justify-content-center mb-2">
                                                        <!-- Avatar -->
                                                        <img class="avatar avatar-lg" src="{{ $partner->img }}"
                                                    ...
                                                    <div class="mb-4">
                                                        ...
                                                        <span class="fs-5">
                                                            {{ Carbon\Carbon::parse($partner->created_at)->format('h:m A  d M Y') }}</span>
                                                    </div>


                                                </div>
                                                <!-- End Body -->
                                                <a class="stretched-link" href="{{ $partner->link }}"></a>
