                ...
                <div class="page-header">
                    <div class="row align-items-center">
                        <div class="col-sm mb-2 mb-sm-0">
                            ...
                            <h1 class="page-header-title">Update Service</h1>
                ...
                <div class="row">
                    <div class="col-lg-8 mb-3 mb-lg-0">
                        ...
                        <div class="card mb-3 mb-lg-5">
                            ...
                            <!-- Body -->
                            <form action="/servlice/{{ $id->id }}/update" enctype="multipart/form-data"
                                method="post">
                                @csrf
                                <div class="card-body">
                                    <!-- Form -->
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input type="text" class="form-control" name="sub" id="productNameLabel"
                                            placeholder="Branding." aria-label="Branding." value="{{ $id->sub }}">
                                    </div>
                                    <!-- End Form -->
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input type="text" class="form-control" name="link" id="productNameLabel"
                                            placeholder="Whats app msg" value="{{ $id->link }}">
                                    </div>
                                    <!-- End Form -->
                                    <div class="row">
                                        <div class="col-sm-6">
                                                ...
                                                <label class="row form-check form-switch" for="availabilitySwitch1">
                                                    ...
                                                    <span class="col-4 col-sm-3 text-end">
                                                        <input name="exclusive"
                                                            @if ($id->exclusive == 1) checked @endif type="checkbox"
                                                            class="form-check-input" id="availabilitySwitch1">
                                                    </span>
                                                </label>
                                                <!-- End Form Switch -->
                                    ...
                                    <!-- Quill -->
                                    <textarea name="description" id="editor" cols="30" rows="10">{{ $id->content }}</textarea>
