                        ...
                        <div class="dropdown">
                            <a class="navbar-dropdown-account-wrapper" href="javascript:;" id="accountNavbarDropdown"
                                ...
                                <div class="avatar avatar-sm avatar-circle">
                                    <img class="avatar-img" src="{{ auth()->user()->profile_photo_path }}"
            ...
            <div class="navbar-vertical-footer-offset">
                ...
                <div class="navbar-vertical-content">
                    <div id="navbarVerticalMenu" class="nav nav-pills nav-vertical card-navbar-nav">
                        ...
                        <div class="nav-item">
                            <a class="nav-link dropdown-toggle " href="#navbarVerticalMenuPagesUserProfileMenu"
                                ...
                                <span class="nav-link-title">Products <span
                                        class="badge bg-primary rounded-pill ms-1">2</span></span>
                            </a>
                            ...
                            <div id="navbarVerticalMenuPagesUserProfileMenu" class="nav-collapse collapse "
                                ...
                                <a class="nav-link " href="{{ route('product_new') }}">New</a>
                            </div>
                        </div>
                        <!-- End Collapse -->
                        ...
                        <!-- Collapse -->
                        <div class="nav-item">
                            <a class="nav-link dropdown-toggle " href="#navbarVerticalMenuPagesUserProfileMenuu"
                                role="button" data-bs-toggle="collapse"
                                data-bs-target="#navbarVerticalMenuPagesUserProfileMenuu" aria-expanded="false"
                                aria-controls="navbarVerticalMenuPagesUserProfileMenuu">
                                <i class="bi-cast nav-icon"></i>
                                <span class="nav-link-title">Portfolios<span
                                        class="badge bg-warning rounded-pill ms-1">2</span></span>
                            </a>

                            <div id="navbarVerticalMenuPagesUserProfileMenuu" class="nav-collapse collapse "
                                data-bs-parent="#navbarVerticalMenuPagesMenu">
                                <a class="nav-link " href="{{ route('portfolios') }}">All</a>
                                <a class="nav-link " href="{{ route('portfolio_create') }}">New</a>
                            </div>
                        </div>
                        <!-- End Collapse -->
                        ...
                        <div class="nav-item">
                            <a class="nav-link dropdown-toggle " href="#navbarVerticalMenuPagesEcommerceMenu"
                                ...
                                <span class="nav-link-title">Services <span
                                        class="badge bg-danger rounded-pill ms-1">2</span></span>
                            </a>

                            <div id="navbarVerticalMenuPagesEcommerceMenu" class="nav-collapse collapse "
                                data-bs-parent="#navbarVerticalMenuPagesMenu">

                                <a class="nav-link " href="{{ route('services') }}">All</a>
                                <a class="nav-link " href="{{ route('services_new') }}">New</a>
                            </div>
                        </div>
                        <!-- End Collapse -->
                        <!-- Collapse -->
                        <div class="nav-item">
                            <a class="nav-link dropdown-toggle " href="#navbarVerticalMenuPagesEcommerceMenu1"
                                role="button" data-bs-toggle="collapse"
                                data-bs-target="#navbarVerticalMenuPagesEcommerceMenu1" aria-expanded="false"
                                aria-controls="navbarVerticalMenuPagesEcommerceMenu1">
                                <i class="bi-award nav-icon"></i>
                                <span class="nav-link-title">Partners <span
                                        class="badge bg-success rounded-pill ms-1">2</span></span>
                            </a>

                            <div id="navbarVerticalMenuPagesEcommerceMenu1" class="nav-collapse collapse "
                                data-bs-parent="#navbarVerticalMenuPagesMenu">

                                <a class="nav-link " href="{{ route('partners') }}">All</a>
                                <a class="nav-link " href="{{ route('partner_new') }}">New</a>
                            </div>
                        </div>
                        <!-- End Collapse -->
                        ...
                        <!-- Collapse -->
                        <div class="nav-item">
                            <a class="nav-link dropdown-toggle " href="#navbarVerticalMenuPagesEcommerceMenu2"
                                role="button" data-bs-toggle="collapse"
                                data-bs-target="#navbarVerticalMenuPagesEcommerceMenu2" aria-expanded="false"
                                aria-controls="navbarVerticalMenuPagesEcommerceMenu2">
                                <i class="bi-people nav-icon"></i>
                                <span class="nav-link-title">Clients <span
                                        class="badge bg-dark rounded-pill ms-1">2</span></span>
                            </a>

                            <div id="navbarVerticalMenuPagesEcommerceMenu2" class="nav-collapse collapse "
                                data-bs-parent="#navbarVerticalMenuPagesMenu">

                                <a class="nav-link " href="{{ route('clients') }}">All</a>
                                <a class="nav-link " href="{{ route('clients_new') }}">New</a>
                            </div>
                        </div>
                        <!-- End Collapse -->
                    ...
                    <div class="row">
                        ...
                        <div class="col-auto">
                            <a class="d-flex align-items-center small text-body" href="#">
                                <img class="avatar avatar-xss avatar-4x3 me-2" src="/assets/svg/brands/gmail-icon.svg"
                                    alt="Image Description">
                                Import contacts
                            </a>
                        </div>
