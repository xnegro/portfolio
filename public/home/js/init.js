...
function edrea_tm_portfolio_popup() {
    ...
    button.off().on('click', function () {
        ...
        modalBox.find('.portfolio_popup_details').prepend('<div class="top_image"><img src="' + image + '" alt="" /><div class="main" data-img-url="' + image + '"></div></div>');
...
function edrea_tm_news_popup() {
    ...
    button.off().on('click', function () {
        ...
        modalBox.addClass('opened');
        modalBox.find('.description_wrap').html(content);
        modalBox.find('.news_popup_details').prepend('<div class="top_image"><img src="' + image + '" alt="" /><div class="main" data-img-url="' + image + '"></div></div>');
